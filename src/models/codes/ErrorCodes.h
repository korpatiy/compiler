#ifndef COMPILER_SRC_MODELS_CODES_H_
#define COMPILER_SRC_MODELS_CODES_H_
...
const std::map<int, std::string> errorTable = {
    ...
    {200, "должно идти имя"},
    {70, "должно быть служебное слово PROGRAM"},
    {109, "должен идти символ  ')'"},
    {105, "должен идти символ  ':'"},
    {6, "запрещенный символ"},
    {7, "ошибка в списке параметров"},
    {26, "должно идти  OF"},
    {108, "должен идти символ  '('"},
    {10, "ошибка в типе"},
    {112, "должен идти символ  '{'"},
    {12, "должен идти символ  ''"},
    {30, "должно идти слово  END"},
    {104, "должен идти символ  ';'"},
    {15, "должно идти целое"},
    {102, "должен идти символ  '='"},
    {50, "ожидался BEGIN или раздел описаний"},
    {18, "ошибка в разделе описаний"},
    {19, "ошибка в списке полей"},
    {20, "должен идти символ  ','"},
    {103, "ошибка в переменной"},
    {22, "ошибка в разделе операторов"},
    {23, "ошибка в выражении"},
    {45, "должно идти слово TYPE"},
    {50, "ошибка в константе"},
    {123, "должен идти символ  ':='"},
    {40, "должно идти слово  THEN"},
    {55, "должно идти слово  UNTIL"},
    {21, "должно идти слово  DO"},
    {25, "должно идти слово  TO  или  DOWNTO"},
    {20, "должно идти слово  IF"},
    {106, "должен идти символ  '.'"},
    {124, "должен идти символ  '..'"},
    ...
    {201, "ошибка в числовой константе: должна идти цифра"},
    ...
    {400, "переопределение константы"},
    {401, "несоответствие типов"},
};


#endif //COMPILER_SRC_MODELS_CODES_H_
